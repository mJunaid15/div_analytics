  ...
  return (
    <>
      ...
      <Herosec
        ...
        para="Research provides the justifcation to start planning and plotting your course for success."
        secondPara="See below how we can help."
      />

      <section className="specializations d-flex align-items-center">
        <div className="container">
          <h1 className="speciH1">How To Data</h1>
          <p className="soeciPara">
          Research can be simply divided into People, Places and Competition.
          </p>

          <div className="row g-0">
            <div className="col-12 col-md-4 col-lg-4">
              <button className="specibtn selectedstate">
              Competitor + Viability Analysis
              </button>
              <button className="specibtn">Product-Market-Fit</button>
              <button className="specibtn">Technical Analysis</button>
              <button className="specibtn">Sentiment Analysis</button>
              <button className="specibtn">Trend Forecasting</button>
              <button className="specibtn">Trend Analysis</button>
